...
const unitsList = {
    data: [
        { id: "un1", name: "Centro", address: "R. das Flores, 123", active: true, createdAt: "2026-01-01T00:00:00Z" },
        { id: "un2", name: "Tatuapé", address: null, active: false, createdAt: "2026-02-01T00:00:00Z" },
    ],
    page: 0,
    size: 20,
    total: 2,
...
describe("UnitsPage", () => {
    it("OWNER sees 'Nova unidade' and Ações column with rows", async () => {
        ...
        expect(screen.getByRole("button", { name: /nova unidade/i })).toBeInTheDocument()
    ...
    it("renders '—' for null address", async () => {
        ...
        renderWithProviders(<UnitsPage />)
        await waitFor(() => expect(screen.getByText("Tatuapé")).toBeInTheDocument())
