...
export function PurchaseOrderForm({ mode, initial }: Props) {
  ...
  function onIngredientChange(index: number, ingredientId: string) {
    form.setValue(`items.${index}.ingredientId`, ingredientId, {
      shouldDirty: true,
    });
      ...
      <form className="space-y-6" onSubmit={form.handleSubmit(onSubmit)}>
                ...
                >
                  <FormControl>
                    <SelectTrigger>
                      <SelectValue
                        placeholder={
                          suppliers.isPending ? "Carregando..." : "Selecione..."
                        }
                      />
                    </SelectTrigger>
                  </FormControl>
                ...
                >
                  <FormControl>
                    <SelectTrigger>
                      <SelectValue
                        placeholder={
                          units.isPending ? "Carregando..." : "Selecione..."
                        }
                      />
                    </SelectTrigger>
                  </FormControl>
        ...
        >
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-1">
                    <label
                      htmlFor={`po-item-${i}-subtotal`}
                      className="text-sm font-medium leading-none"
                    >
                      Subtotal
                    </label>
                    <Input
                      id={`po-item-${i}-subtotal`}
                      readOnly
          ...
          <Button
            ...
            variant="ghost"
            onClick={() =>
              append({ ingredientId: "", quantity: 0, unitPrice: 0 })
            }
          >
          ...
          <div className="flex justify-end border-t border-border/40 pt-3 text-sm font-medium">
            Total:{" "}
            <span data-testid="po-total" className="ml-2">
              R$ {total.toFixed(2)}
            </span>
          </div>
        </section>
