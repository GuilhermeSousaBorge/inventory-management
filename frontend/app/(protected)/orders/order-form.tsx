...
export function OrderForm({ mode, initial }: Props) {
  ...
  const total = watchedItems.reduce(
    (acc: number, it) =>
      acc + (Number(it?.quantity) || 0) * productPrice(it?.productId ?? ""),
    0,
  );
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-1">
                    <label
                      htmlFor={`order-item-${i}-price`}
                      className="text-sm font-medium leading-none"
                    >
                      Preço
                    </label>
                    <Input
                      id={`order-item-${i}-price`}
                      readOnly
                  ...
                  <div className="space-y-1">
                    <label
                      htmlFor={`order-item-${i}-subtotal`}
                      className="text-sm font-medium leading-none"
                    >
                      Subtotal
                    </label>
                    <Input
                      id={`order-item-${i}-subtotal`}
                      readOnly
